    ...
    <div class="coupons-main">
      <div class="search-bar">
        <div class="bar-head box_shadow_small fff_bg_color">
          ...
          <h3 class="fl">Coupons Management</h3>
          <!--<span class="bar-add-btn fr cps_bg_orange text-center cursor_point">Add Link</span>-->
          <router-link to="/advertiser/advertisers/couponsAdd" class="bar-add-btn fr cps_bg_orange text-center cursor_point" tag="span">Add Coupon</router-link>
        </div>
